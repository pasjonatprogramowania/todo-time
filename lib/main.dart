...
const String screenTimeBoxName = 'screen_time_data';
const String settingsBoxName = 'app_settings'; // For theme and other settings
...
void main() async {
  ...
  await Hive.openBox(screenTimeBoxName);
  await Hive.openBox(settingsBoxName); // Open settings box
