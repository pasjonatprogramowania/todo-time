...
import 'package:task_time/presentation/providers/settings_providers.dart'; // Import settings providers
      ...
      body: ListView(
        ...
        children: <Widget>[
          ListTile(
            ...
            // No onTap needed if using DropdownButton as trailing
          ),
          const Divider(),
          Padding(
          ...
          if (usageStatsDebugState.stats != null)
            ...
            const Divider(),
             ListTile(
              ...
              leading: const Icon(Icons.visibility), // Changed icon
              onTap: () async {
                 if (ref.read(overlayPermissionProvider).asData?.value == true) {
                    ...
                    final bool? success = await OverlayChannel.showOverlay(); // showOverlay returns bool?
                    developer.log("Show overlay call result: $success", name: "SettingsPage"); // Log the boolean
                 } else {
                    ScaffoldMessenger.of(context).showSnackBar(
             ...
             ListTile(
              ...
              leading: const Icon(Icons.visibility_off), // Changed icon
              onTap: () async {
